...
@JsonTypeInfo(use = JsonTypeInfo.com.fasterxml.jackson.annotation.JsonTypeInfo.Id.NAME, property = "@type", defaultImpl = JournalBatteryQuery.class)
@JsonSubTypes(@JsonSubTypes.Type(name = "JournalBatteryQuery", value = JournalBatteryQuery.class))
public class JournalBatteryQuery {
